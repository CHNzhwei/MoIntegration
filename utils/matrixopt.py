...
class Scatter2Grid:
    ...
    def fit(self, df, split_channels = False, channel_col = 'Channels', channel_order = []):
        """
        parameters
        ------------------
        ...
        self.df = df
        try:
            df.to_csv("F:\\GitHub\\bidd-molmap-master\\config\\%s-Grid.csv"%(self.Nmap))
        except:
            pass
